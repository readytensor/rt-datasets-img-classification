...
DATA_DIR = os.path.join(".", "data", "CUB_200_2011", "images")
PROCESSED_DIR = os.path.join(".", "..", "..", "processed", "cub_200_2011")


TRAIN_TEST_SPLIT_FILE = os.path.join(".", "train_test_split.json")
